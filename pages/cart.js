  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center pb-10">
        <Head>
          <title>Multilabs Systems - Cart</title>
          <meta name="description" content={`Multilabs Systems - Shopping cart`} />
          <meta property="og:title" content="Multilabs Systems - Cart" key="title" />
        </Head>
        <div className="
