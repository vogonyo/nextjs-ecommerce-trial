...
const Category = (props) => {
  ...
  return (
    <>
      <CartLink />
      <Head>
        <title>Multilabs Systems - {title}</title>
        <meta name="description" content={`Multilabs Systems - ${title}`} />
        <meta property="og:title" content={`Multilabs Systems - ${title}`} key="title" />
      </Head>
