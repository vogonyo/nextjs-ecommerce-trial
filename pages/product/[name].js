...
const ItemView = (props) => {
  ...
  return (
    <>
      <CartLink />
      <Head>
        <title>Multilab Systems - {name}</title>
        <meta name="description" content={description} />
        <meta property="og:title" content={`Multilab Systems- ${name}`} key="title" />
      </Head>
      <div className="
        sm:py-12
        md:flex-row
      ...
      ">
        ...
        <div className="pt-2 px-0 md:px-10 pb-8 w-full md:w-1/2">
          ...
          ">{name}</h1>
          <h2 className="text-2xl tracking-wide sm:py-8 py-6">KES {price}</h2>
