  ...
  return (
    <>
      ...
      <div className="w-full">
        <Head>
          <title>Multilabs Systems</title>
          <meta name="description" content="Multilabs Systems home of the best stores" />
          <meta property="og:title" content="Multilabs Systems" key="title" />
        </Head>
      ...
      <div className="pt-10 pb-6 flex flex-col items-center">
        ...
        <p className="text-gray-600 text-sm">Find lab equipments with common use in your lab</p>
      </div>
