  ...
  return (
    <>
      <div className="w-full">
        <CartLink />
        <Head>
          <title>Multilabs Systems - All Categories</title>
          <meta name="description" content={`Multilabs Systems - All categories`} />
          <meta property="og:title" content="Multilabs Systems - All Categories" key="title" />
        </Head>
        <div className="
          pt-4 sm:pt-10 pb-8
        ">
